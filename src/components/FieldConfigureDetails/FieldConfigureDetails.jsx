...
const FieldConfigureDetails = (props) => {
    ...
    const configuredIndex = clientControlData.statusAudits?.findIndex(x => x.status === "CONFIGURED" || x.status === "APPROVED")
        ...
        <>
                    ...
                    < Grid container className={styles.row}>
                        <Grid item xs={12} className={styles.buttonCol}>
                            ...
                            {(roles.indexOf('QA User Access') !== -1 &&
                                ...
                                <>
                                    <MatButton className={styles.button} onClick={openProductReviewDialog}>Failed Testing</MatButton>
            ...
            {open && (
                <ReviewNeededPopup
                    ...
                    status={clientControlData.status === 'CONFIGURED' ? "CONFIG_REVIEW_NEEDED" : "PRODUCT_REVIEW_NEEDED"}
                    open={open}
                />
            )}
        </>
...
export default FieldConfigureDetails;
