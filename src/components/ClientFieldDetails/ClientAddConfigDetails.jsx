...
import ClientTabConfigurationDetails from './ClientTabConfigurationDetails';
...
const ClientAddConfigDetails = (props) => {
    ...
    function getTabContent(step) {
        switch (step) {
            case 0:
                return <ClientTabConfigurationDetails handleNext={handleConfigNext} 
                handleConfiguration={handleSave} fieldData={field} updateConfig={updateConfig}
                configDetails={config}/>;
            case 1:
                return <ClientTabAddMapping handleAddMapping={handlePrev} configDetails={config} />;
            default:
...
export default ClientAddConfigDetails;
